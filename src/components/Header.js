...
import { Bell, Mic, UserCircle, Video } from "lucide-react"
...
function Header() {
    ...
    return (
        <header className={`flex h-16  gap-5 w-full fixed top-0 z-30 px-4 align-middle items-center ${top ? 'bg-transparent' : 'bg-primary'}`}>
            <SidebarTrigger className="[&>svg]:size-6 text-gray-300 [&_svg]:size-6 p-4 rounded-full hover:bg-sidebar-accent hover:text-gray-300 hidden lg:inline-flex"></SidebarTrigger>
            <div className="flex justify-between content-between w-full align-middle items-center">
                <div className="w-3/12 flex align-middle items-center">
                    <Link href='/' title="Youtube Home" className="inline-block">
                        <svg xmlns="http://www.w3.org/2000/svg" id="yt-ringo2-svg_yt9" width="93" height="20" viewBox="0 0 93 20" focusable="false" aria-hidden="true">
                            <g>
                ...
                <div className="w-5/12 justify-center align-middle items-center gap-4 hidden lg:flex">
                    <Search></Search>
                    <div className="p-3 bg-sidebar-accent rounded-full">
                        <Mic size={20}></Mic>
                    </div>
                </div>
                <div className="w-3/12 flex justify-end align-middle items-center gap-7 px-5">
                    <div className="">
                        <Video className="text-gray-300" size={25} strokeWidth={2}></Video>
                    </div>
                    <div className="">
                        <Bell className="text-gray-300" size={25}></Bell>
                    </div>
                    <div className="">
                        <UserCircle className="text-gray-300" size={25}></UserCircle>
                    </div>
                </div>
            </div>
        </header>
